...
public class PeopleController {
    ...
    public String show(@PathVariable("id") int id, Model model) {
    	if(id==1 || personDAO.show(id)==null) return "redirect:/people"; //making sure that an inexistent person or our the object with id=1 used to determinate null won't be accesed
